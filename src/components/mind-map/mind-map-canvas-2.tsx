...
export default function MindMapCanvas({
  ...
  // Navigation breadcrumb component removed - would need proper state management
  // When re-implementing, ensure breadcrumb buttons have cursor-pointer class
  ...
  return (
    <div className="relative w-full h-full min-h-[500px] sm:min-h-[700px] bg-gradient-to-br from-background via-background/98 to-muted/10 border border-border/30 rounded-3xl overflow-hidden shadow-2xl shadow-black/20 backdrop-blur-sm">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        />
        <div
          className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-pink-500/3 via-blue-500/3 to-purple-500/3 animate-pulse"
          style={{ animationDuration: "6s", animationDelay: "2s" }}
        />
        <div
          className="absolute inset-0 bg-gradient-to-tl from-purple-500/4 via-transparent to-blue-500/4 animate-pulse"
      ...
      {isLoading && (
        <div className="absolute inset-0 bg-gradient-to-br from-background/95 via-blue-500/5 to-purple-500/5 backdrop-blur-md flex items-center justify-center z-20">
          ...
          <div className="flex flex-col items-center space-y-6 relative z-10">
            <div className="relative">
              ...
              <div
                className="animate-spin rounded-full h-16 w-16 border-4 border-purple-500/40 border-t-transparent absolute inset-0"
                style={{ animationDirection: "reverse", animationDuration: "1.5s" }}
              ></div>
              <div
                className="animate-spin rounded-full h-16 w-16 border-4 border-pink-500/20 border-b-transparent absolute inset-0"
      ...
      {error && (
        <div className="absolute inset-0 bg-gradient-to-br from-background/95 via-red-500/5 to-orange-500/5 backdrop-blur-lg flex items-center justify-center z-20 p-6">
          {/* Enhanced background for error state */}
          <div className="absolute inset-0 opacity-20">
            <div
              className="absolute inset-0 bg-gradient-to-r from-red-500/8 via-orange-500/8 to-yellow-500/8 animate-pulse"
              style={{ animationDuration: "4s" }}
            />
          </div>

          <Card className="p-8 bg-gradient-to-br from-muted/20 to-red-500/5 border-border/40 shadow-2xl max-w-lg mx-4 relative overflow-hidden">
      ...
      {!mindMapData && !isLoading && !error && (
        <div className="absolute inset-0 flex items-center justify-center p-8">
          ...
          <Card className="p-10 bg-gradient-to-br from-card/95 via-card/90 to-blue-500/5 backdrop-blur-xl border-border/40 shadow-2xl max-w-lg mx-4 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-purple-500/5 to-transparent animate-pulse" />

            <div className="relative text-center space-y-8">
              <div className="w-24 h-24 mx-auto bg-gradient-to-br from-blue-500/20 via-purple-500/20 to-pink-500/20 rounded-full flex items-center justify-center relative overflow-hidden">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-foreground bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
                  Ready to Explore
                </h3>
